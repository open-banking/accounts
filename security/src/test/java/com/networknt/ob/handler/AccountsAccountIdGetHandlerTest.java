...
public class AccountsAccountIdGetHandlerTest {
    ...
    public void testAccountsAccountIdGetHandlerTest() throws ClientException {
        ...
        String requestUri = "/accounts/FbXtE";
        String httpMethod = "get";
        try {
            ClientRequest request = new ClientRequest().setPath(requestUri).setMethod(Methods.GET);
            
            //customized header parameters 
            request.getRequestHeaders().put(new HttpString("Authorization"), "XwFxAmkFdG");
            request.getRequestHeaders().put(new HttpString("x-customer-user-agent"), "wwqNlyAkLmdvHumvDGpC");
            request.getRequestHeaders().put(new HttpString("x-fapi-interaction-id"), "vkaWyyVdab");
            request.getRequestHeaders().put(new HttpString("x-fapi-customer-ip-address"), "kXtzCwIDgzPXl");
            request.getRequestHeaders().put(new HttpString("x-fapi-financial-id"), "FjXPiQFbca");
            request.getRequestHeaders().put(new HttpString("x-fapi-customer-last-logged-time"), "ZRlGQGehPsrVowUA");
